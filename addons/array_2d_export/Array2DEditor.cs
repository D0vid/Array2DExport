...
[Tool]
public partial class Array2DEditor : EditorProperty
{
    private static readonly StringName SceneName = "res://addons/array_2d_export/array_2d.tscn";

    private SpinBox _gridSizeSpinBox;
    private Array2DGrid _grid;
    ...
    public override void _Ready()
    {
        ...
        _grid = scene.GetNode<Array2DGrid>("Array2DGrid");
